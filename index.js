...
// 1. Firebase ulanishi
// index.js dagi eski ulanishni shunga almashtiring:
...
// 2. Render/Koyeb uchun Mini-Server
...
bot.start(async (ctx) => {
    try {
        ...
        // Foydalanuvchini bazada yangilash yoki yaratish
        await userRef.set({
            userId: userId,
...
bot.hears('📊 Statistika', async (ctx) => {
    ...
    const channelsCount = (await db.collection('channels').count().get()).data().count;
